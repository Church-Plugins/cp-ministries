<?php
namespace CP_Ministries;

/**
 * Provides the global $CP_Ministries object
 *
 * @author costmo
 */
class Init {
	...
	public function required_plugins() {
		printf( '<div class="error"><p>%s</p></div>', __( 'Your system does not meet the requirements for Church Plugins - Ministries', 'cp-ministries' ) );
	}

	/** Helper Methods **************************************/

	public function get_default_thumb() {
		return CP_MINISTRIES_PLUGIN_URL . '/app/public/logo512.png';
	}
	...
	public function get_plugin_name() {
		return __( 'Church Plugins - Ministries', 'cp-ministries' );
	}
	...
	public function get_plugin_path() {
		return CP_MINISTRIES_PLUGIN_DIR;
	}
